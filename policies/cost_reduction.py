...
class CostReductionPolicy(ABC):
    def __init__(
        self,
        stopping_critiria: Optional[Callable[[Iteration], bool]] = None,
...
class EnvelopeBasedCostReduction(CostReductionPolicy):
    ...
    def get_K(
        ...
        k_values, envelope_values = envelope.calculate_envelope(
    ...
    def get_optimal_k_segments(
        self, cost_table: np.ndarray, message_data: np.ndarray
