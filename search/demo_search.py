...
try:
    ...
    from search import DSAComputator, MGMComputator
...
def demo_computators_only():
    ...
    cost_table = [[2.0, 1.0],   # x1=0, x2=0 -> cost=2; x1=0, x2=1 -> cost=1
                  [3.0, 4.0]]   # x1=1, x2=0 -> cost=3; x1=1, x2=1 -> cost=4
...
def demo_full_engines():
    """Demo the full DSA and MGM engines with factor graphs."""
    ...
    print(f"Initial assignment: x1={fg_dsa.variables[0].curr_assignment}, x2={fg_dsa.variables[1].curr_assignment}")
    ...
    print(f"Initial assignment: x1={fg_mgm.variables[0].curr_assignment}, x2={fg_mgm.variables[1].curr_assignment}")
