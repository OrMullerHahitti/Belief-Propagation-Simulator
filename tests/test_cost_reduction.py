...
def test_cost_reduction_all_factors():
    ...
    np.testing.assert_array_almost_equal(factor1.cost_table, cost_table1 * reduction_factor)
    np.testing.assert_array_almost_equal(factor2.cost_table, cost_table2 * reduction_factor)
