...
from src.propflow.policies.bp_policies import DampingPolicy, CostReductionPolicy, SplittingPolicy
...
class TestBasicPolicies:
    ...
    def test_damping_policy_with_different_factors(self, sample_factor_graph, damping_factor):
    ...
    def test_splitting_policy_with_different_ratios(self, sample_factor_graph, split_ratio):
...
class TestPolicyIntegration:
    """Test suite for policy integration with engines."""
    ...
    def test_different_engines_same_graph(self, sample_factor_graph):
        """Test different engines on the same graph."""
        # Damping engine
