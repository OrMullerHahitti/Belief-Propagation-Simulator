...
def plot_gap_preserved_regions(
    cost_matrix, axis=1, edge_values=None, delta_q_range=(-15, 15), title=None
):
    ...
    for i in range(n_out):
        ...
        for interval in all_row_intervals[i]:
            ...
            if delta_q_range[0] < bp < delta_q_range[1]:
                ...
                # Plot the dot
                plt.plot(
                    bp, y_val, "o", color=color, markersize=5, markeredgecolor="white"
                )
