...
lowers the final cost.  Delaying the split is the best distributed variant on
every family; with held-out selection of the delay its gain over immediate
splitting is established on random dense and scale-free graphs.  The learned
solver DABP remains better by $0.1$--$0.2\%$ on random dense and sparse
graphs, at the price of centralized execution.
